...
var findProjectRoot = function () { return __awaiter(void 0, void 0, void 0, function () {
    var location, files;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                location = path_1.default.resolve(__dirname, "../../..");
                _a.label = 1;
            case 1:
                ...
                return [4 /*yield*/, promises_1.default.readdir(location)];
            case 2:
                files = _a.sent();
                if (files.some(function (f) { return f === "package.json"; })) {
