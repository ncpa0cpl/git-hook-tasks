...
const prepareTsFile = (pm, cwd, location) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield pm.run("tsc", location, "-m", "commonjs", "--allowJs", "--esModuleInterop", "--skipLibCheck", "--incremental", "--tsBuildInfoFile", path_1.default.join(cacheDir, "tsbuildinfo"), "--outDir", cacheDir);
