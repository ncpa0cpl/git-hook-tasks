...
var readConfig = function (cwd) { return __awaiter(void 0, void 0, void 0, function () {
    var files, config, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                _b = (_a = JSON).parse;
                return [4 /*yield*/, promises_1.default.readFile(path_1.default.resolve(cwd, exports.CONFIG_FILE_NAME), {
                        encoding: "utf-8",
                    })];
            case 2:
                config = _b.apply(_a, [_c.sent()]);
                return [2 /*return*/, (0, validate_config_1.validateConfig)(config)];
        }
    });
}); };
